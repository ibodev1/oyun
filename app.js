...
function animate() {
  if (playing) {
    ...
    player.draw();
    puan.innerHTML = "Puanın : " + score;
    les.innerHTML = "Leş : " + kills;
    level.innerHTML = "Level : " + levels;
    p_puan.innerHTML = "Puanın : " + score;
    p_les.innerHTML = "Leş : " + kills;
    p_level.innerHTML = "Level : " + levels;
  }
}
...
function init() {
  ...
  player = new Player(width / 2, height / 2, 20, "#f2f2f2");
  addEnemy();
  animate();
}
